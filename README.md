...
本人又是小白，对很多信息都没有自己的判断，经常看网上各种数据分析的头头是道，本着怀疑的精神去研究这些数据的来源；所以想到了自己把原始数据爬下来，就可以印证别人说的到底是真话还是假话了。
...
- restrict：更详细的限制条件，如：限制只看普通住宅、70-130㎡、300-400W，对应的字符串就是：sf1a3a4a5p3
            限制条件对应的字符串可以通过打开链家网站，选择到某个具体的限制条件后，根据网页地址的变化就知道了。https://sh.lianjia.com/ershoufang/songjiang/pg19sf1a3a4a5p3/

如果你的需求跟我一样，直接执行：bash shanghai.sh。
